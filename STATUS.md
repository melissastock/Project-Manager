...
| Combat Injury Post-Incident Medical Tracking & VA Claims Documentation System | active | main | clean | ahead:0 behind:0 | e202c32 | Add discovery workflow and domain model docs; parent Project Manager; GitHub CIMPT (private) |
...
| Momentum-OS | active | codex/momentum-os-report-to-project-manager | clean | ahead:0 behind:0 | cc1bff2 | Remove stale Momentum-OS snapshot files; GitHub momentum-os (private) |

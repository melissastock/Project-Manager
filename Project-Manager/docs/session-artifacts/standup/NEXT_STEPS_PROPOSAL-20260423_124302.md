# Next steps proposal (20260423_124302)
...
- **Resume Builder** (score 3): classify untracked vs intentional artifacts; prefer explicit paths when committing.
- **Archiavellian** (score 2): classify untracked vs intentional artifacts; prefer explicit paths when committing.
- **Aneumind and TC Structure** (score 1): classify untracked vs intentional artifacts; prefer explicit paths when committing.
- **App Builder** (score 1): classify untracked vs intentional artifacts; prefer explicit paths when committing.

...
This folder is the **portfolio control plane** inside the parent [eight-domain portfolio repository](../README.md). Child repositories and gitlinks live at the **repository root** (alongside this folder); paths in `config/repos.json` are relative to that root.
